...
const ProgressSlider = () => {
  ...
  const totalTime = () => {
    return buildTime(progress.duration-progress.position);
  }
  const currentTime = () => {
    return buildTime(progress.position);
  }
...
return (
    ...
    <Slider
      ...
      <Box dir='row' align='center' justify='between'>
        <Text style={styles.timers}>{currentTime()}</Text>
        <Text style={styles.timers}>{totalTime()}</Text>
      </Box>
    </View>
  );
}
